...
//  Sewer Bros
//
//  Created by victor alejandro reza rodriguez on 02/10/14.
...
+ (SKBGatorz *)initNewGatorz:(SKScene *)whichScene startingPoint:(CGPoint)location gatorzIndex:(int)index{
    ...
    gatorz.physicsBody.contactTestBitMask = kBaseCategory | kWallCategory | kLedgeCategory |
                                            kPipeCategory | kGatorzCategory | kRatzCategory | kCoinCategory ;
    gatorz.physicsBody.collisionBitMask = kBaseCategory | kWallCategory | kLedgeCategory |
                                            kPlayerCategory | kGatorzCategory | kRatzCategory | kCoinCategory ;
